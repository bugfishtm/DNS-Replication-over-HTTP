...
-- Dumping structure for table kiedel.dnshttp_binded_domain
CREATE TABLE IF NOT EXISTS `dnshttp_binded_domain` (
...
-- Dumping data for table kiedel.dnshttp_binded_domain: ~0 rows (approximately)
/*!40000 ALTER TABLE `dnshttp_binded_domain` DISABLE KEYS */;
/*!40000 ALTER TABLE `dnshttp_binded_domain` ENABLE KEYS */;
