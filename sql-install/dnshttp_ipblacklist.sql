...
-- Dumping structure for table kiedel.dnshttp_ipblacklist
CREATE TABLE IF NOT EXISTS `dnshttp_ipblacklist` (
...
-- Dumping data for table kiedel.dnshttp_ipblacklist: ~0 rows (approximately)
/*!40000 ALTER TABLE `dnshttp_ipblacklist` DISABLE KEYS */;
/*!40000 ALTER TABLE `dnshttp_ipblacklist` ENABLE KEYS */;
